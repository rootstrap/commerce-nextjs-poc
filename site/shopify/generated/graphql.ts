  ...
  checkoutCreate?: {
    ...
    checkout?: {
      ...
      lineItems: {
        ...
        edges: Array<{
          __typename?: 'CheckoutLineItemEdge'
          node: { __typename?: 'CheckoutLineItem'; id: string }
        }>
      }
      subtotalPrice: {
        __typename?: 'MoneyV2'
...
export type CheckoutShippingAddressUpdateV2Mutation = {
  __typename?: 'Mutation'
...
export const useCheckoutCreateMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: CheckoutCreateMutationVariables) =>
      fetcher<CheckoutCreateMutation, CheckoutCreateMutationVariables>(
        client,
...
useCheckoutCreateMutation.fetcher = (
  client: GraphQLClient,
  variables?: CheckoutCreateMutationVariables,
  headers?: RequestInit['headers']
) =>
...
export const CheckoutShippingAddressUpdateV2Document = /*#__PURE__*/ `
  ...
  checkoutShippingAddressUpdateV2(
    ...
    `
export const useCheckoutShippingAddressUpdateV2Mutation = <
  TError = unknown,
  TContext = unknown
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    ...
    TError,
    CheckoutShippingAddressUpdateV2MutationVariables,
    TContext
  >,
  headers?: RequestInit['headers']
) =>
  ...
  >(
    ['checkoutShippingAddressUpdateV2'],
    (variables?: CheckoutShippingAddressUpdateV2MutationVariables) =>
      fetcher<
        CheckoutShippingAddressUpdateV2Mutation,
        CheckoutShippingAddressUpdateV2MutationVariables
      >(client, CheckoutShippingAddressUpdateV2Document, variables, headers)(),
    options
  )
useCheckoutShippingAddressUpdateV2Mutation.fetcher = (
  client: GraphQLClient,
  variables: CheckoutShippingAddressUpdateV2MutationVariables,
  headers?: RequestInit['headers']
) =>
...
useGetAllProductsQuery.getKey = (variables?: GetAllProductsQueryVariables) =>
...
>(
  ...
  useInfiniteQuery<GetAllProductsQuery, TError, TData>(
    variables === undefined
      ? ['getAllProducts.infinite']
      : ['getAllProducts.infinite', variables],
    (metaData) =>
      fetcher<GetAllProductsQuery, GetAllProductsQueryVariables>(
        client,
        GetAllProductsDocument,
...
useInfiniteGetAllProductsQuery.getKey = (
  variables?: GetAllProductsQueryVariables
) =>
  variables === undefined
    ? ['getAllProducts.infinite']
    : ['getAllProducts.infinite', variables]
useGetAllProductsQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetAllProductsQueryVariables,
  headers?: RequestInit['headers']
) =>
...
useGetCartQuery.getKey = (variables?: GetCartQueryVariables) =>
  variables === undefined ? ['getCart'] : ['getCart', variables]
export const useInfiniteGetCartQuery = <TData = GetCartQuery, TError = unknown>(
...
export const GetCheckoutDocument = /*#__PURE__*/ `
  ...
  node(
    ...
    `
export const useGetCheckoutQuery = <TData = GetCheckoutQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<GetCheckoutQuery, TError, TData>(
    ...
    fetcher<GetCheckoutQuery, GetCheckoutQueryVariables>(
      client,
      GetCheckoutDocument,
      variables,
      headers
...
useGetCheckoutQuery.getKey = (variables?: GetCheckoutQueryVariables) =>
  variables === undefined ? ['getCheckout'] : ['getCheckout', variables]
...
>(
  ...
  useInfiniteQuery<GetCheckoutQuery, TError, TData>(
    variables === undefined
      ? ['getCheckout.infinite']
      : ['getCheckout.infinite', variables],
    (metaData) =>
      fetcher<GetCheckoutQuery, GetCheckoutQueryVariables>(
        client,
        GetCheckoutDocument,
...
useInfiniteGetCheckoutQuery.getKey = (variables?: GetCheckoutQueryVariables) =>
  variables === undefined
    ? ['getCheckout.infinite']
    : ['getCheckout.infinite', variables]
useGetCheckoutQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetCheckoutQueryVariables,
  headers?: RequestInit['headers']
) =>
...
>(
  ...
  useQuery<IntrospectionQueryQuery, TError, TData>(
    variables === undefined
      ? ['IntrospectionQuery']
      : ['IntrospectionQuery', variables],
    fetcher<IntrospectionQueryQuery, IntrospectionQueryQueryVariables>(
      client,
      IntrospectionQueryDocument,
      variables,
      headers
    ),
    options
...
useIntrospectionQueryQuery.getKey = (
  variables?: IntrospectionQueryQueryVariables
) =>
  variables === undefined
    ? ['IntrospectionQuery']
...
>(
  ...
  useInfiniteQuery<IntrospectionQueryQuery, TError, TData>(
    variables === undefined
      ? ['IntrospectionQuery.infinite']
      : ['IntrospectionQuery.infinite', variables],
    (metaData) =>
      fetcher<IntrospectionQueryQuery, IntrospectionQueryQueryVariables>(
        client,
        IntrospectionQueryDocument,
...
useInfiniteIntrospectionQueryQuery.getKey = (
  variables?: IntrospectionQueryQueryVariables
) =>
  variables === undefined
    ? ['IntrospectionQuery.infinite']
    : ['IntrospectionQuery.infinite', variables]
useIntrospectionQueryQuery.fetcher = (
  client: GraphQLClient,
  variables?: IntrospectionQueryQueryVariables,
  headers?: RequestInit['headers']
) =>
